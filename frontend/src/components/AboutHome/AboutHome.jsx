  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 px-4 sm:px-0">
            {aboutfeature.map((item, i) => (
              <div
                key={i}
                className="flex flex-col items-center justify-center gap-3 sm:gap-4 transition-transform
                duration-300 p-4 sm:p-5 hover:translate-x-2"
              >
                <div
                  className={`p-3 sm:p-4 rounded-full bg-gradient-to-r ${item.color} 
          ...
          <div className="flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0">
            ...
            >
              <span
                className="absolute inset-0 bg-gradient-to-r from-amber-600/30 to-transparent
        ...
        <div
          className="w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 relative
        group transform hover:scale-[1.01] transition-all duration-500"
        >
          <div
            className="relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 
          hover:border-amber-600/40 transition duration-500 shadow-2xl shadow-black/50"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-amber-400/15 via-transparent to-amber-600/10 mix-blend-light" />
            <img
              src={AboutImage}
              alt="Restaurant"
            ...
            />
            <div
              className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-4/5 h-16 bg-amber-900/30 blur-3xl
            z-0"
            />
          </div>
